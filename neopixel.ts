...
namespace neopixel {
    ...
    export class Strip {
        ...
        _snakePattern: boolean; // reverse every second row of pixels in matrix
         ...
         */
        //% blockId=neopixel_set_matrix_width block="%strip|set matrix width %width|snake pattern %snakePattern"
        //% strip.defl=strip
        //% blockGap=8
        //% weight=5
        //% parts="neopixel" advanced=true
